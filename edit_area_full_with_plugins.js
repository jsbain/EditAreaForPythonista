...
+"	/**\n"
+"	 * Get called once this file is loaded (eA still not initialized)\n"
+"	 *\n"
+"	 * @return nothing	 \n"
+"	 */	 	 	\n"
+"	init: function(){	\n"
...
+"	 * A control can be a button, select list or any other HTML item to present in the EA user interface.\n"
...
+"				return parent.eAL.get_button_html('charmap_but', 'charmap.gif', 'charmap_press', false, this.baseURL);\n"
+"		}\n"
+"		return false;\n"
+"	}\n"
+"	/**\n"
+"	 * Get called once EA is fully loaded and initialised\n"
+"	 *	 \n"
+"	 * @return nothing\n"
+"	 */	 	 	\n"
+"	,onload: function(){ \n"
+"		if(eA.settings[\"charmap_default\"] && eA.settings[\"charmap_default\"].length>0)\n"
+"			this.default_language= eA.settings[\"charmap_default\"];\n"
+"	}\n"
+"	\n"
+"	/**\n"
...
+"};\n"
+"\n"
+"// Adds the plugin class to the list of available EA plugins\n"
+"eA.add_plugin(\"charmap\", EditArea_charmap);\n"
+"/**\n"
...
+"		eA.load_css(this.baseURL+\"css/test.css\");\n"
+"		eA.load_script(this.baseURL+\"test2.js\");\n"
+"	}\n"
+"	/**\n"
+"	 * Returns the HTML code for a specific control string or false if this plugin doesn't have that control.\n"
+"	 * A control can be a button, select list or any other HTML item to present in the EA user interface.\n"
...
+"			case \"test_but\":\n"
+"				// Control id, button img, command\n"
+"				return parent.eAL.get_button_html('test_but', 'test.gif', 'test_cmd', false, this.baseURL);\n"
+"			case \"test_select\":\n"
+"				html= \"<select id='test_select' onchange='javascript:eA.execCommand(\\\"test_select_change\\\")' fileSpecific='no'>\"\n"
...
+"				if(val!=-1)\n"
+"					parent.eAL.insertTags(eA.id, \"<\"+val+\">\", \"</\"+val+\">\");\n"
...
+"	 * The prefix is needed so they doesn't collide with future EA callback functions.\n"
+"	 *\n"
...
+"\n"
+"// Adds the plugin class to the list of available EA plugins\n"
+"eA.add_plugin(\"test\", EditArea_test);\n"
